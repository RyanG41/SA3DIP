...
4. **Obtain and organize 3D instance bounding boxes**
   ...
   We provide the organized bounding boxes generated by [V-DETR](https://github.com/V-DETR/V-DETR) in folder `detection`. You can follow the same format (by checking the key/value term in pth file using torch) and leverage other bounding boxes obtained by any detection methods.
