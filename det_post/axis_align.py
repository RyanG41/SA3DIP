...
def transform(file_name, mesh_file, meta_file, new_dir):
    ...
    plydata['vertex'].data['y'] = -pts[:, 2]
    plydata['vertex'].data['z'] = pts[:, 1]
...
def main():
    ...
    base_dir = 'data/ScanNet/scans'
    new_dir = 'data/ScanNet/scans_val_transformed'
    if not os.path.exists(new_dir):
        os.makedirs(new_dir)

    file_val = "det_post/scannetv2_val.txt"
